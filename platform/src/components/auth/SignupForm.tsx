...
export default function SignupForm() {
  ...
  if (state.success) {
    return (
      <div className="px-4 py-3 rounded-lg bg-green-900/40 border border-green-700 text-green-300 text-sm text-center">
        Check your email to confirm your account, then{' '}
        <a href="/login" className="underline hover:text-green-200">sign in</a>.
      </div>
    );
  }
